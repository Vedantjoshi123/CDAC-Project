...
const CourseDetails = () => {
  ...
  useEffect(() => {
    ...
    if (found) {
      setCourseData({
        ...found,
        courseTitle: found.title || '', // Fallback if courseTitle is undefined
        ...
        <div className="w-full sm:w-[420px] max-w-md shadow-lg rounded bg-white dark:bg-gray-900 overflow-hidden">
          ...
          <div className="p-5">
            ...
            <div className="flex items-center text-sm gap-4 pt-3 text-gray-500 dark:text-gray-300">
              <div className="flex items-center gap-1"><img src={assets.star} alt="star" /><p>{averageRating.toFixed(1)}</p></div>
